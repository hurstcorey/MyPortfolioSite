      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
                ...
                Hosted on AWS via Amplify, S3, and CloudFront. 
          </p>
          <div>
            <Link
              href="/#contact"
        ...
        >
          <div className="rounded-full bg-gradient-to-br from-stone-900  via-stone-700 to-neutral-500 w-[250px] h-[250px] lg:w-[325px] lg:h-[325px] relative">
            <Image
